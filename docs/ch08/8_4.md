...
（ノートオン同期モード）
delay が負数のとき：
ノートオンでＬＦＯシーケンスが再スタートしない、ノートオン非同期モードと
なります。いかなる負数の値も、このモード指定と判定されます。

ノートオン非同期モードにおいて、任意のタイミングでＬＦＯ位相のリセットを
